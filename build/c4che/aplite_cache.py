...
CFLAGS_cshlib = ['-fPIC']
CPPPATH_ST = '-I%s'
DEFINES = ['RELEASE', 'PBL_PLATFORM_APLITE', 'PBL_BW', 'PBL_RECT', 'PBL_COMPASS', 'PBL_DISPLAY_WIDTH=144', 'PBL_DISPLAY_HEIGHT=168', 'PBL_SDK_FROZEN', 'PBL_SDK_3']
DEFINES_ST = '-D%s'
DEST_BINFMT = 'elf'
DEST_CPU = 'arm'
DEST_OS = 'darwin'
...
PEBBLE_SDK_PLATFORM = '/Users/kellyheitz/Library/Application Support/Pebble SDK/SDKs/current/sdk-core/pebble/aplite'
...
PREFIX = '/usr/local'
PROJECT_INFO = {'displayName': 'literary-watch', 'uuid': '1a8e155f-6c9a-4310-9e0f-2e4a23494ad2', 'sdkVersion': '3', 'enableMultiJS': True, 'targetPlatforms': ['aplite', 'basalt', 'chalk', 'diorite', 'emery', 'flint', 'gabbro'], 'watchapp': {'watchface': True}, 'messageKeys': {'dummy': 10000}, 'resources': {'media': [{'type': 'raw', 'name': 'QUOTES_DATA', 'file': 'data/quotes.bin'}, {'type': 'bitmap', 'name': 'SKY_DAWN', 'file': 'images/sky/dawn.png'}, {'type': 'bitmap', 'name': 'SKY_MORNING', 'file': 'images/sky/morning.png'}, {'type': 'bitmap', 'name': 'SKY_MIDDAY', 'file': 'images/sky/midday.png'}, {'type': 'bitmap', 'name': 'SKY_AFTERNOON', 'file': 'images/sky/afternoon.png'}, {'type': 'bitmap', 'name': 'SKY_DUSK', 'file': 'images/sky/dusk.png'}, {'type': 'bitmap', 'name': 'SKY_NIGHT', 'file': 'images/sky/night.png'}]}, 'name': 'literary-watch', 'shortName': 'literary-watch', 'longName': 'literary-watch', 'versionLabel': '1.0.0', 'companyName': 'MakeAwesomeHappen', 'appKeys': {'dummy': 10000}}
